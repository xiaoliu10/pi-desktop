...
const localPi: LocalPiApi = {
  ...
  deleteArchivedSession: key => invoke('deleteArchivedSession', key),
  composerSkills: cwd => invoke('composerSkills', cwd),
  voiceConfig: () => invoke('voiceConfig'),
  voiceSaveModel: input => invoke('voiceSaveModel', input),
  voiceRemoveModel: id => invoke('voiceRemoveModel', id),
  voiceSetActive: id => invoke('voiceSetActive', id),
  voiceTranscribe: (bytes, mime) => invoke('voiceTranscribe', bytes, mime),
  ...
  memoryRead: (rel: string, cwd?: string) => invoke('memoryRead', rel, cwd),
  memoryOpen: (rel, cwd, appId) => invoke('memoryOpen', rel, cwd, appId),
