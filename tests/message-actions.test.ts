...
const labels = { you:'你', assistant:'助手', simulatedRun:'模拟', toolRunning:'运行中', toolDone:'完成', toolError:'出错', working:'工作中', queued:'已排队', copyMessage:'复制', copied:'已复制', editMessage:'编辑并重发', resend:'重发', cancel:'取消', details:'详情' } as unknown as ChatViewProps['labels'];
const userTurn = {
